...
<head>
    ...
    <title>@yield('title','pharmacies')</title>
    <link rel="canonical" href="https://getbootstrap.com/docs/5.3/examples/sidebars/">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@docsearch/css@3">
    <link href="/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/css/complate-style.css">
...
<body>
    ...
    <div class="dropdown position-fixed bottom-0 start-0 mb-3 ms-3 me-3 bd-mode-toggle">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text">
            <li>
                <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="light"
                    aria-pressed="false">
                    <svg class="bi me-2 ms-2 opacity-50 theme-icon" width="1em" height="1em">
    ...
    {{-- <h1>{{ Request::is('categories*') ? Request::path()  :  Request::path()}}</h1> --}}
        ...
        <div id="sidebarId" class="   d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar">
            ...
            <a href="{{ route('web.main.index') }}"
                ...
                <span class="fs-4 sidebar-text"> صيدليتي</span>
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto my-padding">
                <li class="nav-item">
                    <a href="{{ route('web.pharmacies.index')}}" class="nav-link  {{ Request::is('pharmacies*') ? 'active' : '' }}  {{ Request::is('/*') ? 'active' : '' }}" aria-current="page">
                        ...
                        <span class="sidebar-text">الصيدليات</span>
                ...
                <li >
                    <a href="{{ route('web.main.index') }}" class="nav-link text-white {{ Request::is('categories/main*') ? 'active' : '' }} " >
                        ...
                        <span class="sidebar-text">الأصناف الرئيسية</span>

                    </a>
                </li>
                <li>
                    <a href="{{ route('web.sub.index') }}" class="nav-link  text-white {{ Request::is('categories/sub*') ? 'active' : '' }}">
                        <svg class="bi pe-none ms-2 me-2" width="16" height="16">
                            <use xlink:href="#speedometer2" />
                        </svg>
                        <span class="sidebar-text">الأصناف الفرعية</span>
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                    ...
                    {{-- <img src="https://github.com/mdo.png" alt="" width="32" height="32"
                        class="rounded-circle ms-2 me-2"> --}}
        ...
        <section data-bs-spy="scroll"  class="w-100 scrollbar-primary smooth-scroll">
    ...
    <script src="/js/delete_pharmacy.js"></script>
@stack('scripts')
</body>
